...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getChildrenToRender = function (child) {
    ...
    // 处理出场
    if (i >= 0) {
      var interval = transformArguments(_this5.props.interval, key, i)[1];
      var delay = transformArguments(_this5.props.delay, key, i)[1];
    ...
    return createElement(TweenOne, { key: key, component: child.type, componentProps: child.props, forcedJudg: forcedJudg, animation: animation });
  };
